  ...
  <div class="relative w-full h-screen overflow-hidden bg-surface">
    ...
    <div class="relative z-20 flex flex-col h-full">
      ...
      <div class="px-6 pb-4">
        <div class="relative">
          ...
          <input v-model="airportSearch.searchQuery.value" type="text" placeholder="Search Airport / City"
      ...
      <div class="px-6 pb-3 flex gap-3">
        <button class="flex-1 btn-secondary flex items-center justify-center gap-2 !py-3" :disabled="geo.loading.value"
        ...
        <button class="flex-shrink-0 btn-secondary flex items-center justify-center gap-2 !py-3 !w-auto px-4"
      ...
      <div class="flex-1 overflow-y-auto px-6 pb-6">
        <AirportSearchList :airports="airportSearch.filteredAirports.value" @select="handleAirportSelect" />
      </div>
    </div>
    ...
    <Transition name="confirm">
      <div v-if="confirmAirport" class="fixed inset-0 z-[3000] flex items-end justify-center">
        ...
        <div
          class="relative w-full max-w-md mx-4 mb-8 bg-surface-50 border border-white/10 rounded-3xl p-6 text-center space-y-5">
          ...
          <button class="w-full py-3 text-gray-400 hover:text-white transition-colors font-medium"
