<template>
  <div class="flex items-center justify-center h-full bg-surface p-4 overflow-y-auto">
    <div class="w-full max-w-md">
      ...
      <!-- Check in button -->
      <button class="btn-primary mt-6" @click="handleCheckIn">
        Check in
      </button>

      <!-- Cancel -->
      <button class="w-full mt-3 py-3 text-gray-500 hover:text-gray-300 transition-colors text-sm font-medium"
        @click="handleCancel">
        Cancel Flight
      </button>
    </div>
