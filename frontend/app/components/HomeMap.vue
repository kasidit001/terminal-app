    ...
    <div class="relative w-full h-full overflow-hidden bg-[#060d1a]">
        ...
        <div class="absolute top-0 inset-x-0 z-[100] p-6 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <div
                    class="w-8 h-8 rounded-lg bg-flight-400/10 border border-flight-400/30 flex items-center justify-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <!-- Terminal launcher -->
                <button
                    class="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-emerald-400 hover:border-emerald-400/30 transition-colors"
                    title="Web Terminal" @click="appStore.navigateTo('terminal')">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="absolute bottom-0 inset-x-0 z-[100] p-6 pb-10 space-y-4">
            ...
            <div v-if="statsStore.totalFlights > 0"
                ...
                <div
                    ...
                    <span class="text-xs font-semibold" :class="statsStore.focusLevel.color">{{
                        statsStore.focusLevel.label
                    }}</span>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input v-model="arrivalSearch.searchQuery.value" type="text"
                    ...
                    <div v-else class="mt-2 max-h-48 overflow-y-auto">
                        <AirportSearchList :airports="arrivalSearch.filteredAirports.value"
